...
With our((("Forge Console view")))((("Forge shell"))) new _Forge Console_ view, we're now free to start up the Forge runtime, which came embedded with the JBDS installation.  Clicking the green play button, as shown in <<Figure3-3>>, will give us access to the Forge shell:
