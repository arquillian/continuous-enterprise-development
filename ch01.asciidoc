...
IDE integration, while not standard for Eclipse Juno, is http://testng.org/doc/download.html[simple enough to install] and provides a GUI runner as we've seen in <<Figure1-6>>.(((range="endofrange", startref="ix_ch01-asciidoc5")))(((range="endofrange", startref="ix_ch01-asciidoc4")))(((range="endofrange", startref="ix_ch01-asciidoc3")))
