...
While the full reasoning behind XP is detailed by((("Extreme Programming Explained: Embrace Change, 2E (Beck)")))((("Beck, Kent"))) Kent Beck's _Extreme Programming Explained: Embrace Change, Second Edition_ (Addison-Wesley, 2004), some of its primary tenants can be boiled down to:
