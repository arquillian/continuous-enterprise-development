...
While the full reasoning behind XP is detailed by((("Extreme Programming Explained: Embrace Change, Second Edition (Beck)")))((("Beck, Kent"))) Kent Beck's _Extreme Programming Explained: Embrace Change, Second Edition_ (Addison-Wesley, 2004), some of its primary tenants can be boiled down to:
...
In fact, XP along with other models has both inspired and acts as an implementation of a larger collection of iterative policies as outlined by((("Agile Software Development")))((("Manifesto for Agile Software Development"))) the http://agilemanifesto.org/[_Manifesto for Agile Software Development_]. (((range="endofrange", startref="ix_ch01-asciidoc0")))
