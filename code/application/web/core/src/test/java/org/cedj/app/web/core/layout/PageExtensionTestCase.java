...
import org.cedj.app.web.core.layout.Attachment;
import org.cedj.app.web.core.layout.PageExtension;
...
public class PageExtensionTestCase {
    ...
    public static WebArchive create() {
        WebArchive war = ShrinkWrap
            ...
            .addClass(TestAttachment.class).addAsWebResource(new File("src/test/resources/jsf/page_fragment.xhtml"));
