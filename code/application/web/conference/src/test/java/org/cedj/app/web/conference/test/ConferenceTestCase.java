 ...
 */
package org.cedj.app.web.conference.test;
...
import org.cedj.app.web.conference.ConferenceBean;
import org.cedj.app.web.conference.Current;
import org.cedj.app.web.conference.test.component.ConferenceView;
...
public class ConferenceTestCase {
    ...
    public static WebArchive create() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
            ...
            .addPackage(Conference.class.getPackage()).addAsWebResource(new File("src/main/webapp/conference.xhtml"))
