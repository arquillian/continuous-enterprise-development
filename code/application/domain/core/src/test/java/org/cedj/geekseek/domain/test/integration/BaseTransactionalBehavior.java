...
public abstract class BaseTransactionalBehavior<DOMAIN extends Identifiable, REPO extends Repository<DOMAIN>> {
    ...
    public BaseTransactionalBehavior(Class<DOMAIN> domainClass) {
