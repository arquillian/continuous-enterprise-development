...
public class RelationTestCase {
    ...
    @Test @UsingDataSet("test_objects.yml")
    ...
    @Test @UsingDataSet({"test_objects.yml", "test_object_relations.yml"})
	...
	Assert.assertNotNull(
		"Verify a non null list returned", 
		tagets);
	Assert.assertEquals(
		"Verify expected targets count", 
		1, tagets.size());
