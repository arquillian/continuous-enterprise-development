...
<<ch09>> will involve OAuth authentication using security and identify management from the((("PicketLink", "project location"))) http://www.jboss.org/picketlink[PicketLink project].  We'll again look to REST-assured to help us with our client testing strategy.
