...
Once deployed, you'll be able to launch your web browser of choice, point it to +http://localhost:8080/geekseek+, and explore the screens powering the featureset we've covered here.
