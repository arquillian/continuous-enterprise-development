...
((("Facebook", seealso="authentication, authorization")))((("Twitter", seealso="authentication, authorization")))((("LinkedIn", seealso="authentication, authorization")))((("social authentication", seealso="authentication, authorization")))((("security", seealso="authentication, authorization")))In short, we'll ((("authentication","process")))be using Agorava to handle our _authentication_ process and do the behind-the-scenes interaction with Twitter, powering our sign-in integration.
