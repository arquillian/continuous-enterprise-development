...
* Specific APIs for((("Twitter", "Agorva and", seealso="authentication, authorization")))((("Facebook", "Agorva and", seealso="authentication, authorization")))((("LinkedIn", seealso="authentication, authorization"))) Twitter, Facebook, and LinkedIn

((("social authentication", seealso="authentication, authorization")))In short, we'll ((("authentication","process")))be using Agorava to handle our _authentication_ process and do the behind-the-scenes interaction with Twitter, powering our sign-in integration.
