...
Let's install EAP by unzipping it into a location on the filesystem.  Anywhere will do; for instance, in Unix-like systems we can handle this from the command line:
