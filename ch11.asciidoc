...
In this fashion, we can now automate our testing with EAP just as with WildFly.(((range="endofrange", startref="ix_ch11-asciidoc7"))) (((range="endofrange", startref="ix_ch11-asciidoc4")))(((range="endofrange", startref="ix_ch11-asciidoc3")))(((range="endofrange", startref="ix_ch11-asciidoc2a")))(((range="endofrange", startref="ix_ch11-asciidoc2")))
...
if_match_bug 1
----
The last line is unique to http://bit.ly/1noQj95[Ubuntu-based x64 systems].
...
CloudBees http://bit.ly/1noQQYE[documents this process], and we'll follow along these guidelines.  
