...
((("data","Java Persistence API")))((("Java Persistence API")))((("JPA", see="Java Persistence API")))It's nice that a DBMS allows us to relieve ourselves of the details involving persistence, but introducing this separate data layer presents a few issues:
